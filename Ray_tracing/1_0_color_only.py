...
import numpy as np
import argparse
from ray_tracing_models import Triangle,Ray, Camera, Hittable_list, Sphere, PI

ti.init(arch=ti.gpu)
PI = 3.14159265

# Canvas
aspect_ratio = 1.0  #长宽比
image_width = 800
...
if __name__ == "__main__":
    ...
    scene.add(Triangle(a=ti.Vector([0,0,-1]),b=ti.Vector([-6,2,-1]),c=ti.Vector([-10,-2,-1]),material=1, color=ti.Vector([1.0, 1.0, 1.0])))
