...
import numpy as np
import argparse
from ray_tracing_models import Plane,Ray, Camera, Hittable_list, Sphere, PI
...
if __name__ == "__main__":
    ...
    scene.add(Plane(a=ti.Vector([0,50,-50]),b=ti.Vector([50,50,-25]),c=ti.Vector([50,0,-25]),d=ti.Vector([0,0,-50]),material=1, color=ti.Vector([1.0, 1.0, 1.0])))
